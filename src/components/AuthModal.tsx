...
// Define types for Firebase errors
...
// Memoize the AuthModal component
export const AuthModal = memo(({ isOpen, onClose, mode, onSwitchMode }: AuthModalProps) => {
  ...
  }, [phoneNumber, countryCode, countdown, toast, startCountdown, setupRecaptcha]);
  ...
  }, [otp, confirmationResult, toast, onClose, resetForm]);
